...
const TABS = [
  ...
  { href: "/days", label: "Napok", icon: "calendar-days" },
...
export function TabBar() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-50 flex border-t px-1 pb-[calc(8px+env(safe-area-inset-bottom))] pt-2 backdrop-blur-glass"
      style={{
